...
export default function SalesOrderForm({
    ...
    const { data, setData, post, put, processing, errors } = useForm({
        ...
        order_date: salesOrder?.order_date
            ? salesOrder.order_date.slice(0, 10)
            : new Date().toISOString().slice(0, 10),
        expected_ship_date: salesOrder?.expected_ship_date
            ? salesOrder.expected_ship_date.slice(0, 10)
            : '',
    ...
    const orderTotal = data.items.reduce((sum, item) => {
        return (
            sum +
            (parseFloat(item.ordered_quantity as string) || 0) *
            ...
            <Card>
                ...
                <CardContent className="grid gap-4 md:grid-cols-2">
                    <Field>
                        ...
                        <FieldError
                            errors={[{ message: errors.customer_id }]}
                        />
                    </Field>
                    ...
                    <Field>
                        ...
                        <Input
                            ...
                            onChange={(e) =>
                                setData('expected_ship_date', e.target.value)
                            }
                        />
                        <FieldError
                            errors={[{ message: errors.expected_ship_date }]}
                        />
                    </Field>
