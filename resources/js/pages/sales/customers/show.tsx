...
import { Edit, Trash, Mail, Phone, MapPin, Building, CreditCard } from 'lucide-react';
                        ...
                        <CardContent className="space-y-4">
                            {customer.tax_number && (
                                <div className="grid grid-cols-2">
                                    <span className="font-semibold text-muted-foreground">Tax Number</span>
                            ...
                            {customer.credit_limit && (
                                <div className="grid grid-cols-2">
                                    <span className="font-semibold text-muted-foreground">Credit Limit</span>
                    ...
                    <Card>
                        ...
                        <CardContent>
                            {customer.billing_address ? (
                                ...
                                <p className="text-muted-foreground italic">No billing address provided.</p>
                            )}
                        </CardContent>
                    </Card>
...
Show.layout = (page: React.ReactNode, props: any) => {
    return React.cloneElement(page as React.ReactElement, {
        breadcrumbs: [
            ...
            },
            {
                ...
                href: customers.show({ customer: props.customer.id }),
            },
        ],
    });
};
