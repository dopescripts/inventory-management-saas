...
function Show({ transfer }: Props) {
    ...
    const shipForm = useForm({
        items: transfer.items.map((item) => ({
            ...
            quantity: Math.max(
                0,
                item.quantity_requested - (item.quantity_shipped || 0),
            ),
        })),
    });
    ...
    const receiveForm = useForm({
        items: transfer.items.map((item) => ({
            ...
            quantity: Math.max(
                0,
                (item.quantity_shipped || 0) - (item.quantity_received || 0),
            ),
        })),
    });
            ...
            <div className="flex h-full flex-1 flex-col gap-6 rounded-xl p-4 md:p-6">
                <div className="flex items-start justify-between">
                    <div>
                        <div className="flex items-center gap-3">
                            ...
                            <Badge
                                variant={statusVariant(transfer.status) as any}
                            >
                                {transfer.status
                                    .replaceAll('_', ' ')
                ...
                <div className="grid gap-4 lg:grid-cols-4">
                    ...
                    <Card>
                        ...
                        <CardContent>
                            <div>{transfer.requested_by.name}</div>
                            ...
                            <CardContent className="space-y-4 text-sm">
                                ...
                                {transfer.approved_by && (
                                    <div className="flex justify-between">
                                        ...
                                        <span>{transfer.approved_by.name}</span>
                                    </div>
                                )}
    ...
    return (
        <AppLayout
            breadcrumbs={[
                ...
                {
                    title: '#' + transfer?.transfer_number || 'Details',
                    href: '#',
                },
            ]}
        >
