...
function QuickCreateCategoryDialog({
    ...
    const { data, setData, post, processing, errors, reset } = useHttp<QuickCategoryFormData>({
        name: '',
        slug: '',
        description: '',
        is_active: true,
        ...
        <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
            <DialogContent className="sm:max-w-md">
                ...
                <form onSubmit={submit} className="space-y-4 pt-2">
                    <Field>
                        <FieldLabel htmlFor="quick-category-name">Name</FieldLabel>
                        <Input
                    ...
                    <Field>
                        <FieldLabel htmlFor="quick-category-slug">Slug</FieldLabel>
                        <Input
                    ...
                    <Field>
                        <FieldLabel htmlFor="quick-category-description">Description</FieldLabel>
                        <textarea
...
function QuickCreateBrandDialog({
    ...
    const { data, setData, post, processing, errors, reset } = useHttp<QuickBrandFormData>({
        name: '',
        description: '',
        is_active: true,
    });
        ...
        <Dialog open={open} onOpenChange={(isOpen) => !isOpen && onClose()}>
            <DialogContent className="sm:max-w-md">
                ...
                <form onSubmit={submit} className="space-y-4 pt-2">
                    ...
                    <Field>
                        <FieldLabel htmlFor="quick-brand-description">Description</FieldLabel>
                        <textarea
...
function QuickCreateUnitDialog({
    ...
    const { data, setData, post, processing, errors, reset } = useHttp<QuickUnitFormData>({
        name: '',
        short_name: '',
        type: 'unit',
        description: '',
    ...
    const submit = (event: React.FormEvent): void => {
        ...
        post(units.store.url(), {
            onSuccess: (response: any) => {
                const item = response.data || response;
                onCreated({ id: item.id, name: item.name, short_name: item.short_name });
                reset();
                onClose();
            },
        });
            ...
            <DialogContent className="sm:max-w-md">
                ...
                <form onSubmit={submit} className="space-y-4 pt-2">
                    ...
                    <div className="grid gap-4 md:grid-cols-2">
                        <Field>
                            <FieldLabel htmlFor="quick-unit-short_name">Short Name</FieldLabel>
                            <Input
                        ...
                        <Field>
                            <FieldLabel htmlFor="quick-unit-type">Type</FieldLabel>
                            <select
                                id="quick-unit-type"
                    ...
                    <Field>
                        <FieldLabel htmlFor="quick-unit-description">Description</FieldLabel>
                        <textarea
...
export default function ItemForm({ item, categories: initialCategoryOptions, brands: initialBrandOptions, units: initialUnitOptions }: ItemFormProps) {
    ...
    return (
        <>
            <form onSubmit={submit} className="space-y-6">
                ...
                <div className="grid gap-4 md:grid-cols-2">
                    ...
                    <div className="flex items-center gap-3 pt-7">
                        <Switch id="track_inventory" checked={data.track_inventory} onCheckedChange={(checked) => setData('track_inventory', checked)} />
            ...
            <QuickCreateCategoryDialog
                ...
                onCreated={(item) => {
                    setCategoryOptions((prev) => [...prev, item].sort((a, b) => a.name.localeCompare(b.name)));
            ...
            <QuickCreateBrandDialog
                ...
                onCreated={(item) => {
                    setBrandOptions((prev) => [...prev, item].sort((a, b) => a.name.localeCompare(b.name)));
            ...
            <QuickCreateUnitDialog
                ...
                onCreated={(item) => {
                    setUnitOptions((prev) => [...prev, item].sort((a, b) => a.name.localeCompare(b.name)));
